	...
	render()
	{
		return(
			<div className="working-conditions">
				<AdviceSection literals={this.props.literals} section={["osh-outcomes-working-conditions","working-conditions"]} methodologyData={{section: 'osh-outcomes-working-conditions', subsection: 'Working conditions', indicator: 65}} />
