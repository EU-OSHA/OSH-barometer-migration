	...
	<Provider store={store}>
		...
		<ScrollToTop>
			<Switch>
				...
				<Route exact path="/osh-outcomes-working-conditions/physical-risk/:indicator/:country1?/:country2?" render={routeParams => <App literals={literals} ><PhysicalRisk literals={literals} indicator={'vibrations,-loud-noise-and-temperature'} country1={routeParams.match.params.country1} country2={routeParams.match.params.country2}/></App>} />
				<Route 
